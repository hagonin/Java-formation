...
public class Main {
    ...
    public static void remplirReservoir(Port port, AMoteur vehicule) {
        try {
            ...
            System.out.println("Réservoir rempli pour " + vehicule);
        } catch (Exception e) {
            System.out.println("!!! Erreur pour remplir le réservoir de " + vehicule + " : " + e.getMessage());
        }
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            garer(port, voiture1);
            Voiture voiture2 = new Voiture("Peugeot", "2008", "SD-234-RD");
            garer(port, voiture2);
            ...
            garer(port, new Voiture("Renault", "Clio", "ZZ-350-RD"));
            System.out.println(port + "\n");
            ...
            amarer(port, bateau2);
            Bateau bateau3 = new Bateau("Nausica", "Bermude3", "A3333-SSSD");
            amarer(port, bateau3);
